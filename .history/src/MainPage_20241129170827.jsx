  ...
  return (
    <>
      <div className="min-h-screen bg-[rgb(48,48,48)]">
        ...
        {/* Heading Section */}
        <div className="mt-[-80px] px-4 md:pl-[200px] font-poppins font-medium text-[24px] md:text-[44px] leading-[30px] md:leading-[70px] text-center md:text-left sm:text-2xl">
        ...
        <div className="flex flex-col items-center text-white">
          <div className="relative w-40 h-40 mt-10">
            <div className="absolute border-[10px] border-green-500 rounded-full h-[200px] w-[200px] flex items-center justify-center">
              <div className="text-2xl font-bold">{ivfSuccessRate}%</div>
            </div>
          </div>
          <div className="text-lg mt-12 ml- ">
