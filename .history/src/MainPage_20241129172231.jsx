    ...
    <>
      <div className="min-h-screen bg-[rgb(48,48,48)]">
        ...
        <div className="flex flex-col items-center text-white">
          <div className="relative w-40 h-40 mt-10 md:w-64 md:h-64 md:mt-0 md:ml-10">
            <div className="absolute flex items-center justify-center border-[10px] border-green-500 rounded-full h-full w-full">
        ...
        {/* Button Section */}
        <div className="flex justify-center mt-10 px-4 m">
