    ...
    return (
      <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px] ">
        <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto  ">
          {/* Logo Section */}
          <div className="flex items-center justify-between w-full md:w-auto mr-8 ml-[-40px] sm:w-[100px] ms:h-[25px]  ">
            <div className="flex items-center bg-[#1E231E] p-2 w-[99px] h-[45px] justify-center mb-4 ml-[px] font-poppins font-[600] leading-[30.77px] tracking-[2.47px]  gap-2">
