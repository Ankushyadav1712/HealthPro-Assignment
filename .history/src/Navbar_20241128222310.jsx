    ...
    return (
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px] ">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto ">
                {/* Logo Section */}
                <div className="flex items-center justify-between w-full md:w-auto mr-2 ml-[-10px]">
                    <div className="flex items-center bg-black p-2 w-[99px] h-[45px] justify-center mb-4 ml-[-10px] font-poopins">
                        <span className="text-white text-3xl font-bold leading-40">i</span>
                        <span className="text-white text-3xl font-bold leading-40">V</span>
                        <span className="text-white text-3xl font-bold leading-40">F</span>
                    </div>
                    <span className=" md:block text-2xl  text-black mb-4">Pulse</span>
                    {/* Mobile Menu Toggle */}
                    <button className="md:hidden ml-auto" onClick={() => setMenuOpen(!menuOpen)}>
                        <FontAwesomeIcon icon={menuOpen ? faTimes : faBars} size="xl" className="text-black"/>
                    </button>
