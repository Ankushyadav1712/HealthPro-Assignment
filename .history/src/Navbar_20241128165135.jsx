    ...
    return (
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto">
                ...
                {/* Navigation Menu */}
                <div className={`flex flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'} md:flex md:gap-4 w-full md:w-auto bg-white mt-[12px] pl-[10px] `}>
                    ...
                    <a href="#" className="text-black text-lg w-full md:w-[107px] h-[22px] md:h-auto rounded-[6px] p-2 md:p-0">IVF </a>
