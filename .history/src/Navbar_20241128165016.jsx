        ...
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between w-full md:w-auto">
                    <div className="flex items-center bg-black p-1 w-[99px] h-[45px] justify-center">
                        <span className="text-white text-xl font-bold">i</span>
                        <span className="text-white text-xl font-bold">V</span>
                        <span className="text-white text-xl font-bold">F</span>
                    </div>
                ...
                {/* Navigation Menu */}
                <div className={`flex flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'} md:flex md:gap-4 w-full md:w-auto bg-white `}>
