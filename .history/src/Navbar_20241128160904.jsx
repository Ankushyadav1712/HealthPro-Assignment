    ...
    return (
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto">
                ...
                {/* Navigation Menu */}
                <div className={`flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'}  w-[1176px] h-[68px]  top-[9px] left-[432px]  pt-[10px] pb-[10px] gap-[15px]`}>
                    <a href="#" className="text-black text-lg w-[170px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[8px]">Donor Programme</a>
                    <a href="#" className="text-black text-lg w-[184px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[8px]">Fertility Preser</a>
                    ...
                    <a href="#" className="text-black text-lg w-[107px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[7px]">IVF Testing</a>
                    <a href="#" className="text-black text-lg w-[93px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[7px]">About</a>
                    <button className="bg-red-500 text-white px-4 py-2 w-[143px] h-[48px] rounded-[6px]">
