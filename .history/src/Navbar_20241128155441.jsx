    ...
    return (
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto">
                ...
                {/* Navigation Menu */}
                <div className={`flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'} space-y-4 md:space-y-0 md:space-x-8 mt-4 md:mt-0 w-[1176px] h-[68px] absolute top-[9px] left-[432px] rounded-[10000px] pt-[10px] pb-[10px] gap-[15px]`}>
