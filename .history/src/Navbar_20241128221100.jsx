        ...
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto ml-[-1px]">
                ...
                <div className={`flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'}  w-[1176px] h-[68px]  left-[432px]  pt-[10px]  gap-[1px]`}>
                    ...
                    <a href="#" className="text-black text-lg w-[180px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[2px]">Infertility Treatments</a>
                    <a href="#" className="text-black text-lg w-[139px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[3px] ">IVF Treatments</a>
                    <a href="#" className="text-black text-lg w-[92px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[2px] ml-[20px]">About Us</a>
                    <button className="bg-red-500 text-white  w-[130px] h-[48px] rounded-[6px] ml-[60px]  mb-[100px]">
...
//                     <div className="flex items-center bg-black p-2 w-[99px] h-[45px] justify-center mb-4">
//                         <span className="text-white text-xl font-bold">i</span>
//                         <span className="text-white text-xl font-bold">V</span>
//                         <span className="text-white text-xl font-bold">F</span>
//                     </div>
//                     <span className=" md:block text-2xl font-bold text-black mb-4">Pulse</span>
//                     {/* Mobile Menu Toggle */}
//                     <button className="md:hidden ml-auto" onClick={() => setMenuOpen(!menuOpen)}>
//                         <FontAwesomeIcon icon={menuOpen ? faTimes : faBars} size="xl" className="text-black"/>
//                     </button>
...
//                     <a href="#" className="text-black text-lg w-full md:w-[107px] h-[22px] md:h-auto rounded-[6px] p-2 md:p-0">IVF Treatments </a>
//                     <a href="#" className="text-black text-lg w-full md:w-[93px] h-[22px] md:h-auto rounded-[6px] p-2 md:p-0">About Us</a>
//                     <button className="bg-red-500 text-white w-full md:w-[143px] h-[48px] rounded-[6px] mt-4 md:mt-0">
//                         Talk to Us <i className="fas fa-arrow-right"></i>
//                     </button>
//                 </div>
