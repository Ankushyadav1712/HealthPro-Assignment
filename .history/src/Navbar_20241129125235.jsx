    ...
    return (
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px] ">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto  ">
                {/* Logo Section */}
                <div className="flex items-center justify-between w-full md:w-auto mr-8 ml-[-40px] ">
                    <div className="flex items-center bg-black p-2 w-[99px] h-[45px] justify-center mb-4 ml-[px] font-poppins font-[600] leading-[30.77px] tracking-[2.47px]">
                ...
                <div className={`flex flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'} md:flex md:gap-4 w-full md:w-auto bg-white mt-[12px] pr-[10px] `}>
                    ...
                    <a href="/#" className="text-black text-lg w-full md:w-[201px] h-[22px] md:h-auto rounded-[6px] p-2md:p-0">Advanced Treatments</a>
