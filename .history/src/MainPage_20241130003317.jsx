  ...
  return (
    <>
      <div className="min-h-screen bg-[rgb(48,48,48)]">
        <div className=" ml-[200px]">
          <nav className="text-white text-sm mb-[-70px]">
            <ul className="flex items-center space-x-2 ">
              ...
              <span className="text-gray-500 mb-[-200px]">/</span>
              <li className="font-bold text-white mb-[-200px]">Result</li>
            </ul>
          </nav>
        </div>
        ...
        {/* Heading Section */}
        <div className="mt-[-50px] px-4 md:pl-[200px] font-poppins font-medium text-[13px] md:text-[44px] leading-[30px] md:leading-[70px] text-center md:text-left sm:text-2xl lg:mt-[-53px] ml-[130px] sm:ml-[10px]">
