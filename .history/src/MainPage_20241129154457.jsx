  ...
  return (
    ...
    <div className="relative w-32 h-32 md:w-40 md:h-40">
      <div className="absolute inset-0 bg-green-500 rounded-full overflow-hidden">
        <div className="absolute inset-0 bg-dark-green-700" style={{ clipPath: `circle(${ivfSuccessRate}%)` }}></div>
        <div className="absolute inset-0 flex items-center justify-center text-2xl md:text-3xl font-bold text-white">
          {ivfSuccessRate}%
        </div>
      </div>
    </div>
