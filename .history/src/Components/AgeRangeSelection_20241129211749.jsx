...
const AgeRangeSelection = ({
  ...
  return (
    <div className="flex flex-col items-center bg-[#eeeaea] mt-[150px] p-4">
      <h1 className="sm:text-3xl leading-42 mb-6 text-black text-xl font-medium ml-[-60px] sm:ml-[-20px]">
        Which age range applies to you?
      </h1>
      <div className="sm:grid grid-cols-3 gap-4 flex flex-col ml-[-180px] sm:ml-[]">
        {ageData.map((age) => (
