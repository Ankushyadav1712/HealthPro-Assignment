...
<Components styleName=""></Components>/AgeRangeSelection.css'
...
const AgeRangeSelection = () => {
    ...
    name="age" 
    value={ageRange} 
    className="peer appearance-none border-2 border-orange-500 rounded-full w-5 h-5 checked:border-orange-500 checked:bg-orange-500 relative"
