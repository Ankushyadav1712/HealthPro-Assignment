...
const IVFSlider = ({ ivfCycles, setIvfCycles }) => {
  ...
  return (
    <div className="slider-div text-center font-poppins p-5 mt-5">
      ...
      <div className="relative w-[300px] mx-auto">
        ...
        />
        {/* Custom slider track */}
        <div className="absolute w-full h-[8px] bg-[#e5e7eb] rounded-[2px] top-1/2 transform -translate-y-1/2" />

        {/* Active track */}
        <div className="h-[8px] bg-[#f38175] rounded-[2px] top-1/2 transform -translate-y-1/2 z-[1]"
          style={{
            position: "absolute",
            width: `${((ivfCycles - 1) / 3) * 100}%`,
          }}
        />
