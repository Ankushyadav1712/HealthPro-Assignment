    ...
    <>
        <div className="flex flex-col items-center    bg-[#eeeaea] mt-[50px] ">
            ...
            <div className="grid grid-cols-2 gap-20">
                <div className="flex flex-col items-center">
                    <div className="flex flgap-4">
                        <label className="flex items-center gap-4 text-black">ICSI Procedure: 
                            <input
                            type="radio"
                            name="icsi"
                            value="yes"
        ...
        <div className="flex flex-col items-center ">
            <div className="flex gap-4">
              <label className="flex items-center gap-4 text-black">PGT Testing:
                <input
                  type="radio"
                  name="pgt"
                  value="yes"
