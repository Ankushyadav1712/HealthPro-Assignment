        ...
        {Object.keys(conditions).map((condition) => (
          ...
          >
            <input
              ...
              className="w-5 h-5 border-2 border-orange-500 rounded-md bg-transparent   focus:ring focus:ring-orange-300 focus:outline-none appearance-none checked:text-white"
