...
const AgeRangeSelection = () => {
    ...
    return (
        <div className="flex flex-col items-center    bg-[#eeeaea] mt-[200px] text-3xl">
            <h1 className="text-2xl leading-normal mb-6 text-black">Which age range applies to you?</h1>
