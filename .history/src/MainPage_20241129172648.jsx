  ...
  return (
    <>
      <div className="min-h-screen bg-[rgb(48,48,48)]">
        ...
        {/* Success Rate Circle */}
        <div className="flex flex-col items-center text-white md:items-start md:mt-[50px]">
          <div className="relative w-40 h-40 mt-10 md:w-64 md:h-64 md:mt-0 md:ml-10  md:mr-[-100px]">
          ...
          <div className="text-lg mt-12 ml-10 md:mr-[-10px]">
