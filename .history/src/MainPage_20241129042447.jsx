...
const MainPage = ({selectedAge, value}) => {
    const [ivfSuccessRate, setIvfSuccessRate] = useState()
    ...
    const calculateIVFSuccessRate = (age, cycles) => {
      ...
      return (cumulativeRate * 100).toFixed(2) + "%";
    };
  return (
    <>
        <div className="min-h-screen bg-[rgb(48,48,48)] ">
            ...
            <div className="relative w-40 h-40 mt-[100px] mr-[100px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center text-2xl font-bold ">
                    {Math.floor((selectedAge/value)*100)}%
                </div>
                </div>
            </div>
            <div className=" ml-[-850px] text-lg mt-[100px] ">
                With {value} IVF Cycle
            </div>
            </div>
