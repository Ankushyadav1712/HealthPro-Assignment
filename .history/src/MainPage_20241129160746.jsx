...
const MainPage = ({ ivfDetail }) => {
  ...
  return (
    <>
      <div className="min-h-screen bg-[rgb(48,48,48)]  w-full">
        <div className="relative w-64 h-60 flex  ">
          <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-1/2 h-0.5 bg-orange-500 mt-[100px] relative w-full sm:w-1/2 mt-10"></div>
