  ...
  return (
    <>
      <div className="min-h-screen bg-[rgb(48,48,48)]">
        ...
        {/* Heading Section */}
        <div className="mt-[-35px] px-4 md:pl-[200px] font-poppins font-medium text-[10px] md:text-[44px] leading-[30px] md:leading-[70px] text-center md:text-left sm:text-2xl lg:mt-[-53px] ml-[100px]">
