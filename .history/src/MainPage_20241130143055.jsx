...
const MainPage = ({ ivfDetail }) => {
  ...
  return (
    <>
      <div className="flex  space-x-2 p-4 text-green-400 sm:hidden ">
        {/* Back Arrow Icon */}
        <i className="fas fa-arrow-left fa-lg mt-[100px] ml-[50px]"></i>
        {/* Header Title */}
        <h1 className="text-2xl font-medium mt-[-50px] text-green-400">
          IVF Success Rate Calculator
        </h1>
      </div>
      <div className="min-h-screen bg-[rgb(48,48,48)]">
        <div className=" sm:ml-[200px]">
          <nav className="sm:text-white sm:text-sm mb-[-70px]">
