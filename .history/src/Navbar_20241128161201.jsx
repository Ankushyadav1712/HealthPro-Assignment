    ...
    return (
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto">
                ...
                {/* Navigation Menu */}
                <div className={`flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'}  w-[1176px] h-[68px]  left-[432px]  pt-[20px] pb-[20px] gap-[1px]`}>
                    ...
                    <button className="bg-red-500 text-white px-4 py-2 w-[143px] h-[48px] rounded-[6px] pb-[10px]">
