...
const Navbar = () => {
    ...
    return (
        <header className="w-[1789px] fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto ">
                ...
                <div className={`flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'}  w-[1176px] h-[68px]  left-[432px]  pt-[10px] pb-[20px] gap-[1px]`}>
                    ...
                    <a href="#" className="text-black text-lg w-[184px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[8px]">Fertility Preserva</a>
