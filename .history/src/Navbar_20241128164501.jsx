        ...
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between w-full md:w-auto">
                    ...
                    <span className=" md:block text-2xl font-bold text-black">Pulse</span>
                    {/* Mobile Menu Toggle */}
                    <button className="md:hidden ml-auto" onClick={() => setMenuOpen(!menuOpen)}>
                        <FontAwesomeIcon icon={menuOpen ? faTimes : faBars} size="xl" className="text-black"/>
                    </button>
                ...
                {/* Navigation Menu */}
                <div className={`flex flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'} md:flex md:gap-4 w-full md:w-auto`}>
                    <a href="#" className="text-black text-lg w-full md:w-[170px] h-[22px] md:h-auto rounded-[6px] p-2 md:p-0 hidden ">Donor Programme</a>
