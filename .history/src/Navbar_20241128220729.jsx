        ...
        <header className="w-full fixed top-0 left-0 bg-white shadow-md z-10 h-[85px] mb-[1px]">
            <div className="flex flex-col md:flex-row items-center justify-between p-4 max-w-7xl mx-auto ml-[-1px]">
                ...
                <div className={`flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'}  w-[1176px] h-[68px]  left-[432px]  pt-[10px]  gap-[1px]`}>
                    ...
                    <a href="#" className="text-black text-lg w-[188px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[2px]">Infertility Treatments</a>
                    <a href="#" className="text-black text-lg w-[107px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[3px] mr-[20px]">IVF Treatments</a>
                    <a href="#" className="text-black text-lg w-[93px] h-[22px] rounded-[6px] pr-[10px] pl-[10px] gap-[2px] ml-[20px]">About Us</a>
                    <button className="bg-red-500 text-white  w-[143px] h-[48px] rounded-[6px] ml-[60px] ">
