    ...
    <>
      <div className="min-h-screen bg-[rgb(48,48,48)]">
        ...
        <div className="flex flex-col items-center text-white md:items-start md:mt-[150px] ">
          <div className="relative w-48 h-48 mt-10 md:w-64 md:h-64 md:mt-0 ml-[190px] md:items-start">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-2xl font-bold md:text-3xl sm:text-xl bg-[#032706]">
              {ivfSuccessRate}%
            </div>
          </div>
